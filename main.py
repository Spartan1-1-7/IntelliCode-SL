...
def main() -> None:
    ...
    cli_parser.add_argument(
        "--input", type=str, help="Input data (code or description)"
    )
    cli_parser.add_argument("--file", type=str, help="Read input from file")
    cli_parser.add_argument(
        "--language", type=str, help="Programming language (for generation tasks)"
    )
    cli_parser.add_argument(
        "--context", type=str, help="Additional context (for debugging tasks)"
    )
    cli_parser.add_argument(
        "--auto-route",
        action="store_true",
    ...
    cli_parser.add_argument(
        "--description", type=str, help="Description for auto-routing"
    )
