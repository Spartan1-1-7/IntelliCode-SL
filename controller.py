...
class Controller:
    ...
    def __init__(self):
        ...
        self.task_keywords = {
            TaskType.CLASSIFICATION: [
                "classify", "classification", "identify language", "detect language",
                "complexity", "code type", "analyze type"
            ],
            TaskType.DEBUGGING: [
                "debug", "debugging", "bug", "error", "fix", "issue",
                "vulnerability", "security", "analyze error"
            ],
            TaskType.GENERATION: [
                "generate", "generation", "create", "write code", "complete",
                "refactor", "implement", "code completion"
            ],
            TaskType.DOCUMENTATION: [
                "document", "documentation", "docstring", "readme", "comments",
                "api docs", "explain code"
            ]
        }
    ...
    def auto_route(self, input_data: str, description: str = "", **kwargs) -> Dict[str, Any]:
        """
